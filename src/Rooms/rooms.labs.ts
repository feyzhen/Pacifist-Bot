...
function pickRecipe(room: Room, currentOutput: string | false): [any, any, any] {
    ...
    const recipes: Array<[Recipe, () => boolean]> = [
        ...
        [[RESOURCE_OXYGEN, RESOURCE_HYDROGEN, RESOURCE_HYDROXIDE],
            () => shouldResumeProduction(RESOURCE_HYDROXIDE, st.store[RESOURCE_HYDROXIDE]) && has(RESOURCE_OXYGEN) && has(RESOURCE_HYDROGEN)],
        // Lemergium Hydride → Acid → Catalyzed
        [[RESOURCE_LEMERGIUM, RESOURCE_HYDROGEN, RESOURCE_LEMERGIUM_HYDRIDE],
            () => shouldResumeProduction(RESOURCE_LEMERGIUM_HYDRIDE, st.store[RESOURCE_LEMERGIUM_HYDRIDE]) && has(RESOURCE_LEMERGIUM) && has(RESOURCE_HYDROGEN)],
        [[RESOURCE_HYDROXIDE, RESOURCE_LEMERGIUM_HYDRIDE, RESOURCE_LEMERGIUM_ACID],
            () => shouldResumeProduction(RESOURCE_LEMERGIUM_ACID, st.store[RESOURCE_LEMERGIUM_ACID]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_LEMERGIUM_HYDRIDE)],
        [[RESOURCE_CATALYST, RESOURCE_LEMERGIUM_ACID, RESOURCE_CATALYZED_LEMERGIUM_ACID],
            () => shouldResumeProduction(RESOURCE_CATALYZED_LEMERGIUM_ACID, st.store[RESOURCE_CATALYZED_LEMERGIUM_ACID]) && has(RESOURCE_CATALYST) && has(RESOURCE_LEMERGIUM_ACID)],
        // Utrium Hydride → Acid → Catalyzed
        [[RESOURCE_UTRIUM, RESOURCE_HYDROGEN, RESOURCE_UTRIUM_HYDRIDE],
            () => shouldResumeProduction(RESOURCE_UTRIUM_HYDRIDE, st.store[RESOURCE_UTRIUM_HYDRIDE]) && has(RESOURCE_UTRIUM) && has(RESOURCE_HYDROGEN)],
        [[RESOURCE_HYDROXIDE, RESOURCE_UTRIUM_HYDRIDE, RESOURCE_UTRIUM_ACID],
            () => shouldResumeProduction(RESOURCE_UTRIUM_ACID, st.store[RESOURCE_UTRIUM_ACID]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_UTRIUM_HYDRIDE)],
        [[RESOURCE_CATALYST, RESOURCE_UTRIUM_ACID, RESOURCE_CATALYZED_UTRIUM_ACID],
            () => shouldResumeProduction(RESOURCE_CATALYZED_UTRIUM_ACID, st.store[RESOURCE_CATALYZED_UTRIUM_ACID]) && has(RESOURCE_CATALYST) && has(RESOURCE_UTRIUM_ACID)],
        // Zynthium Oxide → Alkalide → Catalyzed
        [[RESOURCE_OXYGEN, RESOURCE_ZYNTHIUM, RESOURCE_ZYNTHIUM_OXIDE],
            () => shouldResumeProduction(RESOURCE_ZYNTHIUM_OXIDE, st.store[RESOURCE_ZYNTHIUM_OXIDE]) && has(RESOURCE_OXYGEN) && has(RESOURCE_ZYNTHIUM)],
        [[RESOURCE_HYDROXIDE, RESOURCE_ZYNTHIUM_OXIDE, RESOURCE_ZYNTHIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_ZYNTHIUM_ALKALIDE, st.store[RESOURCE_ZYNTHIUM_ALKALIDE]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_ZYNTHIUM_OXIDE)],
        [[RESOURCE_CATALYST, RESOURCE_ZYNTHIUM_ALKALIDE, RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE, st.store[RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE]) && has(RESOURCE_CATALYST) && has(RESOURCE_ZYNTHIUM_ALKALIDE)],
        // Lemergium Oxide → Alkalide → Catalyzed
        [[RESOURCE_LEMERGIUM, RESOURCE_OXYGEN, RESOURCE_LEMERGIUM_OXIDE],
            () => shouldResumeProduction(RESOURCE_LEMERGIUM_OXIDE, st.store[RESOURCE_LEMERGIUM_OXIDE]) && has(RESOURCE_LEMERGIUM) && has(RESOURCE_OXYGEN)],
        [[RESOURCE_HYDROXIDE, RESOURCE_LEMERGIUM_OXIDE, RESOURCE_LEMERGIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_LEMERGIUM_ALKALIDE, st.store[RESOURCE_LEMERGIUM_ALKALIDE]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_LEMERGIUM_OXIDE)],
        [[RESOURCE_CATALYST, RESOURCE_LEMERGIUM_ALKALIDE, RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE, st.store[RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE]) && has(RESOURCE_CATALYST) && has(RESOURCE_LEMERGIUM_ALKALIDE)],
        // Ghodium chain
        [[RESOURCE_ZYNTHIUM, RESOURCE_KEANIUM, RESOURCE_ZYNTHIUM_KEANITE],
            () => shouldResumeProduction(RESOURCE_ZYNTHIUM_KEANITE, st.store[RESOURCE_ZYNTHIUM_KEANITE]) && has(RESOURCE_ZYNTHIUM) && has(RESOURCE_KEANIUM)],
        [[RESOURCE_UTRIUM, RESOURCE_LEMERGIUM, RESOURCE_UTRIUM_LEMERGITE],
            () => shouldResumeProduction(RESOURCE_UTRIUM_LEMERGITE, st.store[RESOURCE_UTRIUM_LEMERGITE]) && has(RESOURCE_UTRIUM) && has(RESOURCE_LEMERGIUM)],
        [[RESOURCE_ZYNTHIUM_KEANITE, RESOURCE_UTRIUM_LEMERGITE, RESOURCE_GHODIUM],
            () => shouldResumeProduction(RESOURCE_GHODIUM, st.store[RESOURCE_GHODIUM]) && has(RESOURCE_ZYNTHIUM_KEANITE) && has(RESOURCE_UTRIUM_LEMERGITE)],
        [[RESOURCE_GHODIUM, RESOURCE_OXYGEN, RESOURCE_GHODIUM_OXIDE],
            () => shouldResumeProduction(RESOURCE_GHODIUM_OXIDE, st.store[RESOURCE_GHODIUM_OXIDE]) && has(RESOURCE_GHODIUM) && has(RESOURCE_OXYGEN)],
        [[RESOURCE_GHODIUM_OXIDE, RESOURCE_HYDROXIDE, RESOURCE_GHODIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_GHODIUM_ALKALIDE, st.store[RESOURCE_GHODIUM_ALKALIDE]) && has(RESOURCE_GHODIUM_OXIDE) && has(RESOURCE_HYDROXIDE)],
        [[RESOURCE_GHODIUM_ALKALIDE, RESOURCE_CATALYST, RESOURCE_CATALYZED_GHODIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_CATALYZED_GHODIUM_ALKALIDE, st.store[RESOURCE_CATALYZED_GHODIUM_ALKALIDE]) && has(RESOURCE_GHODIUM_ALKALIDE) && has(RESOURCE_CATALYST)],
        // Keanium Oxide → Alkalide → Catalyzed
        [[RESOURCE_KEANIUM, RESOURCE_OXYGEN, RESOURCE_KEANIUM_OXIDE],
            () => shouldResumeProduction(RESOURCE_KEANIUM_OXIDE, st.store[RESOURCE_KEANIUM_OXIDE]) && has(RESOURCE_KEANIUM) && has(RESOURCE_OXYGEN)],
        [[RESOURCE_HYDROXIDE, RESOURCE_KEANIUM_OXIDE, RESOURCE_KEANIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_KEANIUM_ALKALIDE, st.store[RESOURCE_KEANIUM_ALKALIDE]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_KEANIUM_OXIDE)],
        [[RESOURCE_CATALYST, RESOURCE_KEANIUM_ALKALIDE, RESOURCE_CATALYZED_KEANIUM_ALKALIDE],
            () => shouldResumeProduction(RESOURCE_CATALYZED_KEANIUM_ALKALIDE, st.store[RESOURCE_CATALYZED_KEANIUM_ALKALIDE]) && has(RESOURCE_CATALYST) && has(RESOURCE_KEANIUM_ALKALIDE)],
        // Keanium Hydride → Acid → Catalyzed
        [[RESOURCE_HYDROGEN, RESOURCE_KEANIUM, RESOURCE_KEANIUM_HYDRIDE],
            () => shouldResumeProduction(RESOURCE_KEANIUM_HYDRIDE, st.store[RESOURCE_KEANIUM_HYDRIDE]) && has(RESOURCE_HYDROGEN) && has(RESOURCE_KEANIUM)],
        [[RESOURCE_HYDROXIDE, RESOURCE_KEANIUM_HYDRIDE, RESOURCE_KEANIUM_ACID],
            () => shouldResumeProduction(RESOURCE_KEANIUM_ACID, st.store[RESOURCE_KEANIUM_ACID]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_KEANIUM_HYDRIDE)],
        [[RESOURCE_CATALYST, RESOURCE_KEANIUM_ACID, RESOURCE_CATALYZED_KEANIUM_ACID],
            () => shouldResumeProduction(RESOURCE_CATALYZED_KEANIUM_ACID, st.store[RESOURCE_CATALYZED_KEANIUM_ACID]) && has(RESOURCE_CATALYST) && has(RESOURCE_KEANIUM_ACID)],
        // Zynthium Hydride → Acid → Catalyzed
        [[RESOURCE_HYDROGEN, RESOURCE_ZYNTHIUM, RESOURCE_ZYNTHIUM_HYDRIDE],
            () => shouldResumeProduction(RESOURCE_ZYNTHIUM_HYDRIDE, st.store[RESOURCE_ZYNTHIUM_HYDRIDE]) && has(RESOURCE_HYDROGEN) && has(RESOURCE_ZYNTHIUM)],
        [[RESOURCE_HYDROXIDE, RESOURCE_ZYNTHIUM_HYDRIDE, RESOURCE_ZYNTHIUM_ACID],
            () => shouldResumeProduction(RESOURCE_ZYNTHIUM_ACID, st.store[RESOURCE_ZYNTHIUM_ACID]) && has(RESOURCE_HYDROXIDE) && has(RESOURCE_ZYNTHIUM_HYDRIDE)],
        [[RESOURCE_CATALYST, RESOURCE_ZYNTHIUM_ACID, RESOURCE_CATALYZED_ZYNTHIUM_ACID],
            () => shouldResumeProduction(RESOURCE_CATALYZED_ZYNTHIUM_ACID, st.store[RESOURCE_CATALYZED_ZYNTHIUM_ACID]) && has(RESOURCE_CATALYST) && has(RESOURCE_ZYNTHIUM_ACID)],
        // Utrium Oxide (miner efficiency) - 特殊高阈值
