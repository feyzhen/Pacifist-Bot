...
const BOOST_COMPOUND_TIERS: {
    ...
    [ATTACK]: {
        ...
        tier2: RESOURCE_UTRIUM_ACID,
        tier1: RESOURCE_UTRIUM_HYDRIDE
    },
    [RANGED_ATTACK]: {
    ...
    [TOUGH]: {
        ...
        tier1: RESOURCE_GHODIUM_OXIDE
    },
    [MOVE]: {
        tier3: RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE,
        tier2: RESOURCE_ZYNTHIUM_ALKALIDE,
        tier1: RESOURCE_ZYNTHIUM_OXIDE
    },
    [HEAL]: {
        tier3: RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE,
        tier2: RESOURCE_LEMERGIUM_ALKALIDE,
        tier1: RESOURCE_LEMERGIUM_OXIDE
    },
    [CARRY]: {
        tier3: RESOURCE_CATALYZED_KEANIUM_ACID,
        tier2: RESOURCE_KEANIUM_ACID,
        tier1: RESOURCE_KEANIUM_HYDRIDE
    }
};
