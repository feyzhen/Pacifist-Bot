...
declare global {
    interface Creep {
        ...
        moveToRoom: (
            roomName: string,
            travelTarget_x?: number,
            travelTarget_y?: number,
            ignoreRoadsBool?: boolean,
            swampCostValue?: number,
            rangeValue?: number
        ) => void;
        ...
        Sweep: (useReserve: boolean) => boolean;
        transferStore: (reversePriority: boolean, useReserveFill: boolean) => boolean;
        recycle: () => void;
